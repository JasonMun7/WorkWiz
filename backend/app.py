...
json_file_path = os.path.join(current_directory, 'data/freelancer_with_USD.json')
...
def cosine_search(query):
    ...
    top_matches_df = pd.DataFrame(top_matches, columns=['cosine_similarity', 'job_title', 'client_average_rating', 'job_description', 'tags', 'avg_price', 'currency', 'usd_val'])
